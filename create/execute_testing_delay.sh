...
python3 testing_delay.py --model 'efficientnet_b3'     --model-dir $ModD/'efficientnet_b3'     --times 10 --dataset-dir $InTsD --dataset-file $InTsF --dataset-name $DName --output-dir $OutDir
python3 testing_delay.py --model 'inception_resnet_v2' --model-dir $ModD/'inception_resnet_v2' --times 10 --dataset-dir $InTsD --dataset-file $InTsF --dataset-name $DName --output-dir $OutDir
python3 testing_delay.py --model 'inception_v3'        --model-dir $ModD/'inception_v3'        --times 10 --dataset-dir $InTsD --dataset-file $InTsF --dataset-name $DName --output-dir $OutDir
python3 testing_delay.py --model 'mobilenet_v3'        --model-dir $ModD/'mobilenet_v3'        --times 10 --dataset-dir $InTsD --dataset-file $InTsF --dataset-name $DName --output-dir $OutDir
python3 testing_delay.py --model 'resnet_v2_50'        --model-dir $ModD/'resnet_v2_50'        --times 10 --dataset-dir $InTsD --dataset-file $InTsF --dataset-name $DName --output-dir $OutDir
